...
import is.toxic.common.service.KafkaService;

import static is.toxic.common.kafka.KafkaStorage.genKafkaStorageName;
        ...
        Допустим("отправляю сообщение в очередь {string}, брокера {string}",
                (String topic, String brokerName) ->
                        service.send(
                                ...
                                topic,
                                null,
                                storage.getString(Common.generateStringKey(Common.KAFKA_STRING_REQUEST_MESSAGE)),
                                null
                        )
        );
